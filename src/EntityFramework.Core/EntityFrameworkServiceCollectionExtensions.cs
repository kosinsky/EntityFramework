    ...
    public static class EntityFrameworkServiceCollectionExtensions
    {
        ...
        private static IServiceCollection AddQuery(this IServiceCollection serviceCollection)
        {
            return serviceCollection
                ...
                .AddTransient<IEntityResultFindingExpressionVisitor, EntityResultFindingExpressionVisitor>()
                .AddTransient<IMemberAccessBindingExpressionVisitor, MemberAccessBindingExpressionVisitor>()
